...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Mon compte</a><div class="dropdown-menu"> <a class="dropdown-item" href="connectClient.jsp">Se connecter</a> <a class="dropdown-item" href="ajoutClient.jsp">S'inscrir</a> 
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="hero bg-image" data-image-src="images/resto4.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Bon appétit</h1>
                <h5 class="font-white space-xs">Découvrez & réservez les meilleurs restaurants au meilleur prix</h5>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Les sélections du moment</h2>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        ...
                        <div class="content">
                            <h5><a href="profile.html">Pavé de maigre à la plancha </a></h5>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        ...
                        <div class="content">
                            ...
                            <div class="product-name">juste braisé pommes rattes truffées</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        ...
                        <div class="content">
                            ...
                            <div class="product-name">pastèque caramélisée, fêta et chou Pak Choï</div>
                ...
                <div class="restaurant-listing">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant thaifood fish pasta">
                        <div class="restaurant-wrap">
                            <div class="row">
                                ...
                                <!--end:col -->
                                <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                    <h5><a href="profile.html">Le 158</a></h5> <span>158 Rue du Vieux Pont de Sèvres 92100</span>
                                    <div class="bottom-part">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant grill pasta pizza">
                        <div class="restaurant-wrap">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                    <a class="restaurant-logo" href="#"> <img src="images/Clémentine-resto.jpg" alt="Restaurant logo" height="95" width="95"> </a>
                                </div>
                                <!--end:col -->
                                <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                    <h5><a href="profile.html">Clémentine-resto</a></h5> <span>5, rue Saint-Marc 75002 Paris France</span>
                                    <div class="bottom-part">
                                        <div class="cost"><i class="fa fa-check"></i>Prix moyen 40 €</div>
                                        <div class="ratings"> <span>
                                        <i class="fa fa-star"></i>
 ...
 <!-- start: FOOTER -->
        <footer class="footer" style="background-color: #437132;">
            <div class="container">
                <h2 align="center" color="white">Suivez-nous!</h2>
                <div align="center">
