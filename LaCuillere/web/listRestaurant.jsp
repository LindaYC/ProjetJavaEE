...
<div class="page-wrapper">
            ...
            <div class="result-show">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-3">
                            <p><span class="primary-color"><strong>3</strong></span> Restaurants trouvé !</div>
                        </p>
                        <div class="col-sm-9">
                                        ...
                                        <ul>
                                            <li>
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Français</span> </label>
                                            </li>
                                            <li>
                                                <label class="custom-control custom-checkbox">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
                                        ...
                                        <div class="entry-dscr">
                                            <h5><a href="#">Café Harcourt By Dalloyau</a></h5> <span>6 Rue de Lota 75116 Paris France <a href="#">...</a></span>
